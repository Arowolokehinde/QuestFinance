    ...
    >
      ...
      <div className="p-6 bg-slate-900/50 border border-slate-800 rounded-xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-2xl font-bold">Quest System</h3>
        </div>
      ...
      <div className="p-6 bg-slate-900/50 border border-slate-800 rounded-xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-2xl font-bold">Soul-Bound NFT Badges</h3>
        </div>
        <p className="text-slate-300 mb-4">
      ...
      <div className="p-6 bg-slate-900/50 border border-slate-800 rounded-xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-2xl font-bold">XP & Leveling System</h3>
        </div>
        <p className="text-slate-300 mb-4">
        ...
        <div className="p-4 bg-slate-800/50 border border-slate-700 rounded-lg">
          <p className="text-sm font-mono text-indigo-400 mb-2">XP Formula:</p>
